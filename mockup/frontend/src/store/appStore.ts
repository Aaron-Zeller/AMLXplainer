...
export const useAppStore = create<AppState>((set) => ({
  ...
  setDashboardPayload: (payload) => set({ dashboardPayload: payload }),
  ...
  toggleFeatureSelection: (featureKey) =>
    set((state) => ({
      selectedFeatureKeys: state.selectedFeatureKeys.includes(featureKey)
        ? state.selectedFeatureKeys.filter((currentKey) => currentKey !== featureKey)
        : [...state.selectedFeatureKeys, featureKey],
    })),
