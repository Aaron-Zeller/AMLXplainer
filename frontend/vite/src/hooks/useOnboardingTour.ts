...
type AlertDecision = 'inReview' | 'closed' | 'mrosReview'
...
type UseOnboardingTourArgs = {
  ...
  transactionAlerts: AlertPreview[]
    ...
    const driverObj = driver({
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            title: 'Triage Alerts',
            description: 'Use Triage on a pending alert to review the model context and record a case status.',
            side: 'right',
            align: 'start',
            onNextClick: () => {
        ...
        },
        {
          ...
          popover: {
            ...
            description: 'Compare model output with the known outcome, then mark the alert as in review, closed, or ready for MROS review.',
            side: 'bottom',
            align: 'start',
            onNextClick: () => {
              setIsTourProcessMenuOpen(false)
